...
/**
 * Represents a {@link Token} that has been identified by a {@link Tagger} as
 * part of 1 or 0 {@link Mention}s. Note that this class does not extend
 * {@link Token}, nor is this class the primary internal representation for
 * mentions. Rather, this is a convenience class whose instances are created on
 * demand
 * 
 * @author Bob
 */
public class TaggedToken
{
	 ...
	 * @return The {@link TagPosition} representing the position of this token
	 *         within the mention (i.e. I, O, B, E, or W)
	 */
	 ...
	 * @param format
	 *            The {@link TagFormat} to use
	 * @return A {@link String} consisting of the text of the token, a pipe
	 *         ("|"), and the tag for this token, as returned by
	 *         getTag(TagFormat)
	 */
	 ...
	 * @param format
	 *            The {@link TagFormat} to use
	 * @return A {@link String} consisting of the {@link TagPosition} for this
	 *         token. If the token is part of a {@link Mention}, this is follwed
	 *         by a dash ("-"), and the {@link MentionType} for the
	 *         {@link Mention}
	 */
	...
	public enum TagPosition
	{
		...
		{
			return TagPosition.getPostion(mention, index).convert(format).name() + "-" + mention.getType().getText();
		}
	}

	/**
	 * @return The {@link Mention} for this token, or <code>null</code> if this
	 *         token is not part of a {@link Mention}
	 */
	...
	{
		return getText(TagFormat.IOBEW);
	}
}
