...
public class CheckTokenization extends Base
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (line != null)
        {
            ...
            outputFile.println(id + "\t" + sentence.getTokenizedText());
            tokenTotal += sentence.getTokens().size();
            int errorCount = checkTokenBoundaries(sentence, tokenizer, tags);
            if (errorCount > 0)
        ...
        System.out.println("Had " + errorTotal + " tokenization errors, with " + tokenTotal + " total tokens");
