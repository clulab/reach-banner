...
/**
 * Performs a 2-fold cross validation: partitions the data into two sets of
 * roughly equal size, trains a model on each and then tests each model on the
 * unseen partition. To perform 5 x 2 cross validation, simply execute this 5
 * times.
 */
public class Evaluate2Fold extends Base
{
	...
	private static Set<Mention> test(ArrayList<Sentence> sentences, CRFTagger tagger, String outputFilename, String mentionFilename) throws IOException
	{
